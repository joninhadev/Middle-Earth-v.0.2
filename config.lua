...
dayKillsToRedSkull = 9
weekKillsToRedSkull = 16
...
maxPlayers = 100
motd = "Bem vindo ao Middle Earth Server!"
onePlayerOnlinePerAccount = true
allowClones = false
serverName = "Middle Earth Server"
statusTimeout = 0
...
-- GAME STORE POR MÓDULOS
gamestoreByModules = false

-- EXPERT PVP
expertPvp = false

-- SISTEMA DE QUESTS POR LUA OU XML.
loadQuestLua = false
...
-- ADICIONAR O NOME DO MAPA E O NOME DO MESMO
mapName = "Bronson"
mapAuthor = "Jonathan Silva"
...
storeImagesUrl = "http://34.95.247.37/images/store/"
