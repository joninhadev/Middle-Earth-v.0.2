local config = {
    ...
    bossPosition = Position(2177, 339, 10), -- {x = 1824, y = 729, z = 12}
    bossArea = {
        fromPos = Position(2167, 332, 10), -- CANTO SUPERIOR ESQUERDO DA SALA {x = 1807, y = 707, z = 12}
        toPos = Position(2187, 350, 10), -- CANTO INFERIOR DIREITO DA SALA {x = 1838, y = 726, z = 12}
        entrancePos = Position(2176, 345, 10), -- POSI??O QUE OS PLAYERS SER?O TELEPORTADOS {x = 1824, y = 709, z = 12}
        exitPosition = Position(2098, 310, 10) -- POSI??O AO SER EXPULSOS {x = 1824, y = 699, z = 12}
    },
    allowedAnyParticipantsCount = true,
    participantsPos = {
        Position(2171, 364, 10), -- PRIMEIRO PUXAR? A ALAVANCA {x = 1824, y = 704, z = 12}
        Position(2170, 364, 10), -- {x = 1823, y = 703, z = 12}
        Position(2169, 364, 10), -- {x = 1824, y = 702, z = 12}
        Position(2172, 364, 10), -- {x = 1825, y = 703, z = 12}
        Position(2173, 364, 10)  -- {x = 1824, y = 703, z = 12}
    },
    attempts = {
        taskPoints = 0, -- MINIMO DE TASK POINTS
        storage = 5941, -- STORAGE DE ESPERA
        seconds = 72000 -- 72000 -- 20 HORAS DE ESPERA
    },
    createTeleportPos = Position(2171, 341, 10), -- POSI??O QUE SER? CRIADO O TP QUANDO O BOSS MORRER {x = 575, y = 1312, z = 6}
    teleportToPosition = Position(2098, 310, 10), -- POSI??O QUE OS PLAYERS SER?O TELETRANSPORTADOS QUANDO FINALIZAREM
...
local creatureEvent = CreatureEvent("bossOberon")
