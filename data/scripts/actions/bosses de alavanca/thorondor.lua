local config = {
    actionId = 5934,
    bossName = "Thorondor",
    bossPosition = Position(1782, 642, 12), -- {x = 1824, y = 729, z = 12}
    bossArea = {
        fromPos = Position(1773, 615, 12), -- CANTO SUPERIOR ESQUERDO DA SALA {x = 1807, y = 707, z = 12}
        toPos = Position(1796, 650, 12), -- CANTO INFERIOR DIREITO DA SALA {x = 1838, y = 726, z = 12}
        entrancePos = Position(1782, 624, 12), -- POSI??O QUE OS PLAYERS SER?O TELEPORTADOS {x = 1824, y = 709, z = 12}
        exitPosition = Position(1782, 610, 12) -- POSI??O AO SER EXPULSOS {x = 1824, y = 699, z = 12}
    },
    allowedAnyParticipantsCount = true,
    participantsPos = {
        Position(1782, 614, 12), -- PRIMEIRO PUXAR? A ALAVANCA {x = 1824, y = 704, z = 12}
        Position(1781, 613, 12), -- {x = 1823, y = 703, z = 12}
        Position(1782, 613, 12), -- {x = 1824, y = 702, z = 12}
        Position(1783, 613, 12), -- {x = 1825, y = 703, z = 12}
        Position(1782, 612, 12)  -- {x = 1824, y = 703, z = 12}
    },
    attempts = {
        taskPoints = 0, -- MINIMO DE TASK POINTS
        storage = 5934, -- STORAGE DE ESPERA
        seconds = 72000 -- 72000 -- 20 HORAS DE ESPERA
    },
    createTeleportPos = Position(1773, 633, 12), -- POSI??O QUE SER? CRIADO O TP QUANDO O BOSS MORRER {x = 575, y = 1312, z = 6}
    teleportToPosition = Position(1782, 610, 12), -- POSI??O QUE OS PLAYERS SER?O TELETRANSPORTADOS QUANDO FINALIZAREM
...
local creatureEvent = CreatureEvent("bossLever2")
