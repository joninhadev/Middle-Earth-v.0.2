...
local teleportPosition = Position(958, 1645, 5)  -- Onde o teleport será criado
...
function bossVenom.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    if storageValue == totalLevers then
        ...
        if teleport then
            ...
            Game.broadcastMessage("As três alavancas foram movidas, Yselda foi despertado!", MESSAGE_EVENT_ADVANCE)
