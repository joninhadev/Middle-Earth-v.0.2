...
local teleportPosition = Position(2086, 123, 6)  -- Onde o teleport será criado
...
function bossIce.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    if storageValue == totalLevers then
        ...
        if teleport then
            ...
            Game.broadcastMessage("As três alavancas foram movidas, Glaurivorn foi despertado!", MESSAGE_EVENT_ADVANCE)
