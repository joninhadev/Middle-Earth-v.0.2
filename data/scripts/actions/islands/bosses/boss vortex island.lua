...
local teleportPosition = Position(2109, 1369, 5)  -- Onde o teleport será criado
...
function bossVortex.onUse(player, item, fromPosition, target, toPosition, isHotkey)
    ...
    if storageValue == totalLevers then
        ...
        if teleport then
            ...
            Game.broadcastMessage("As três alavancas foram movidas, Lórion foi despertado!", MESSAGE_EVENT_ADVANCE)
            ...
            addEvent(function()
                ...
                addEvent(function()
                    ...
                    if boss and boss:getName():lower() == bossName:lower() then
                        boss:remove()
                        Game.broadcastMessage("Lórion voltou para as trevas!", MESSAGE_EVENT_ADVANCE)
                    end
