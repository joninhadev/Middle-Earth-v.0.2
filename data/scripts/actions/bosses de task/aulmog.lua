local config = {
    actionId = 3994,
    bossName = "Aulmog",
    bossPosition = Position(651, 514, 9),
    bossArea = {
        fromPos = Position(641, 511, 9),
        toPos = Position(659, 528, 9),
        entrancePos = Position(647, 526, 9),
        exitPosition = Position(616, 521, 9)
    },
    ...
    attempts = {
        taskPoints = 200, -- PONTOS DE TASK QUE SERÃO REMOVIDOS
        storage = 3994, -- STORAGE DE ESPERA
        seconds = 80 -- TEMPO DE ESPERA [20 horas]
    },
    createTeleportPos = Position(651, 514, 9),
    teleportToPosition = Position(616, 521, 9),
...
local creatureEvent = CreatureEvent("aulmogTask")
