local config = {
    actionId = 3991,
    bossName = "Grishnakh",
    bossPosition = Position(573, 282, 7), -- {x = 827, y = 382, z = 8}
    bossArea = {
        fromPos = Position(567, 282, 7), -- CANTO SUPERIOR ESQUERDO DA SALA {x = 820, y = 380, z = 8}
        toPos = Position(579, 290, 7), -- CANTO INFERIOR DIREITO DA SALA {x = 835, y = 388, z = 8}
        entrancePos = Position(571, 289, 7), -- POSI??O QUE OS PLAYERS SER?O TELEPORTADOS {x = 828, y = 389, z = 8}
        exitPosition = Position(580, 242, 6) -- POSI??O AO SER EXPULSOS {x = 830, y = 401, z = 8}
    },
    allowedAnyParticipantsCount = true,
    participantsPos = {
        Position(548, 283, 7) -- PRIMEIRO PUXAR? A ALAVANCA {x = 830, y = 399, z = 8}
    },
    attempts = {
        taskPoints = 70, -- MINIMO DE TASK POINTS
        storage = 3991, -- STORAGE DE ESPERA
        seconds = 72000 -- HORAS DE ESPERA [20]
    },
    createTeleportPos = Position(573, 282, 7), -- POSI??O QUE SER? CRIADO O TP QUANDO O BOSS MORRER {x = 820, y = 384, z = 8}
    teleportToPosition = Position(580, 242, 6), -- POSI??O QUE OS PLAYERS SER?O TELETRANSPORTADOS QUANDO FINALIZAREM
...
function action.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("grishnakhTask")
...
local creatureEvent = CreatureEvent("grishnakhTask")
