local config = {
    actionId = 3992,
    bossName = "Kalyassa",
    bossPosition = Position(669, 253, 8), -- {x = 827, y = 382, z = 8}
    bossArea = {
        fromPos = Position(656, 246, 8), -- CANTO SUPERIOR ESQUERDO DA SALA {x = 820, y = 380, z = 8}
        toPos = Position(679, 266, 8), -- CANTO INFERIOR DIREITO DA SALA {x = 835, y = 388, z = 8}
        entrancePos = Position(667, 262, 8), -- POSI??O QUE OS PLAYERS SER?O TELEPORTADOS {x = 828, y = 389, z = 8}
        exitPosition = Position(691, 311, 8) -- POSI??O AO SER EXPULSOS {x = 830, y = 401, z = 8}
    },
    allowedAnyParticipantsCount = true,
    participantsPos = {
        Position(687, 308, 8) -- PRIMEIRO PUXAR? A ALAVANCA {x = 830, y = 399, z = 8}
    },
    attempts = {
        taskPoints = 150, -- MINIMO DE TASK POINTS
        storage = 3992, -- STORAGE DE ESPERA
        seconds = 72000 -- HORAS DE ESPERA [20]
    },
    createTeleportPos = Position(663, 254, 8), -- POSI??O QUE SER? CRIADO O TP QUANDO O BOSS MORRER {x = 820, y = 384, z = 8}
    teleportToPosition = Position(691, 311, 8), -- POSI??O QUE OS PLAYERS SER?O TELETRANSPORTADOS QUANDO FINALIZAREM
...
function action.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("kalyassaTask")
...
local creatureEvent = CreatureEvent("kalyassaTask")
