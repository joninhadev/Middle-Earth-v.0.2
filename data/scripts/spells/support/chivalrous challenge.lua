		...
		if lastChainPosition:getDistance(closestMonsterPosition) == 1 then
			...
			if path and #path > 0 then
				for i=1, #path do
					...
					lastChainPosition:sendMagicEffect(219)
				end
				updateLastChain = true
			end
		end
		if updateLastChain then
			closestMonsterPosition:sendMagicEffect(219)
...
spell:vocation("templar knight;true", "chaos knight;true", "orc general; true", "dwarf artisan; true", "divine weaponsmith;true", "divine knight;true")
