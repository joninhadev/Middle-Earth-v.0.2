...
--[[	local lastServerSave = math.max(stg,0)
		...
		Game.updateBoostMonsterSecond()
		Game.updateBoostMonsterThird()
		Game.updateBoostBoss()

	print(">> 1 Boosted monster: ".. Game.getBoostMonster() .. "")
	print(">> 2 Boosted monster: ".. Game.getBoostMonsterSecond() .. "")
	print(">> 3 Boosted monster: ".. Game.getBoostMonsterThird() .. "")
	print(">> 4 Boosted boss: ".. Game.getBoostBoss() .. "")  --]]
