...
travelNode = keywordHandler:addKeyword({'corsario'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Você quer ir para a ilha corsario por 100?'})
	travelNode:addChildKeyword({'yes'}, StdModule.travel, {npcHandler = npcHandler, premium = false, level = 0, cost = 100, destination = Position (870, 1475, 6) })
	travelNode:addChildKeyword({'no'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = 'Tá caro demais pra você?'})
...
travelNode = keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para Dol\'Guldur, Corsario, Lorien, Rivendell, Grey Mountains, Dunedain, Mordor por uma pequena taxa.'})
travelNode = keywordHandler:addKeyword({'ir'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para Dol\'Guldur, Corsario, Lorien, Rivendell, Grey Mountains, Pirata, Dunedain, Mordor por uma pequena taxa.'})
travelNode = keywordHandler:addKeyword({'viajar'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'Posso te levar para Dol\'Guldur, Corsario, Lorien, Rivendell, Grey Mountains, Dunedain, Mordor por uma pequena taxa.'})
