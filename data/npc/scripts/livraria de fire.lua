...
function creatureSayCallback(cid, type, msg)
     ...
     if msgcontains(msg, "mission") then
         if getPlayerStorageValue(cid, storage) == -1 then
             selfSay("Tenho uma missão para você: matar 1000 demons, 1000 hellfire fighter, 1000 spirit of fire e 1000 hellhounds. Você aceita?", cid)
             talkState[talkUser] = 1
         elseif getPlayerStorageValue(cid, storage) == 1 then
             selfSay("Você matou 1000 demons, 1000 hellfire fighters, 1000 spirit of fire e 1000 hellhounds?", cid)
             talkState[talkUser] = 1
         else
     ...
     elseif msgcontains(msg, "yes") and talkState[talkUser] == 1 then
         if getPlayerStorageValue(cid, storage) == -1 then
             ...
             if getPlayerStorageValue(cid, 38118) == 1000 and getPlayerStorageValue(cid, 38119) == 1000 and getPlayerStorageValue(cid, 38120) == 1000 and getPlayerStorageValue(cid, 38121) == 1000 then
                 selfSay("Bom trabalho, agora você pode acessar a livraria de fogo!", cid)
