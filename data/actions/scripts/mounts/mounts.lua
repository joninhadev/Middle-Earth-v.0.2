...
local config = {
	...
	[33273]	= {NAME = 'Flying Book',  ID = 126, TYPE = TYPE_MONSTER, CHANCE = 20, FAIL_MSG = { {1, 'Flying Book has run away.'} }, SUCCESS_MSG = 'You have tamed the flying book.'},
	...
	[36290]	= {NAME = 'Gryphon',  ID = 144, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { {1, 'Gryphon has run away.'} }, SUCCESS_MSG = 'You have tamed the gryphon.'},
	[34664]	= {NAME = 'Hibernal Moth', ID = 131,	TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { {2, 'The hibernal moth is not interested in your lantern and flies away.'}, {4, 'The hibernal moth is not interested in your lantern and flies away.'} }, SUCCESS_MSG = 'You have tamed a hibernal moth.'},
	...
	[34663]	= {NAME = 'Lacewing Moth', ID = 130, TYPE = TYPE_MONSTER, CHANCE = 30, FAIL_MSG = { {2, 'The lacewing moth is not interested in your lantern and flies away.'}, {4, 'The lacewing moth is not interested in your lantern and flies away.'} }, SUCCESS_MSG = 'You have tamed a lancewing moth.'},
	[15546]	= {NAME = 'Lady Bug', ID = 27, TYPE = TYPE_MONSTER, CHANCE = 70,	FAIL_MSG = { {1, 'The ladybug got scared and ran away.'}, {3, 'The ladybug is trying to nibble.'} }, SUCCESS_MSG = 'You tame a lady bug.'},
	...
	[13293]	= {NAME = 'Midnight Panther', ID = 5, TYPE = TYPE_MONSTER, CHANCE = 100, FAIL_MSG = { {1, 'The panther has escaped.'}, {2, 'The whip broke.'} },SUCCESS_MSG = 'You have tamed the panther.'},
	...
	[23810]	= {NAME = 'Noble Lion', ID = 40, TYPE = TYPE_MONSTER, CHANCE = 80, FAIL_MSG = { {2, 'The lion got scared and ran away.'}, {4, 'The lion is trying to nibble.'} }, SUCCESS_MSG = 'You tamed the lion.'},	
	...
	[39661]	= {NAME = 'White Lion', ID = 174,	TYPE = TYPE_MONSTER, CHANCE = 99, FAIL_MSG = { {1, 'The white lion has run away.'}, {3, 'The silk had no effect.'} }, SUCCESS_MSG = 'You have tamed the white lion.'},
	...
	[13939]	= {NAME = 'Wild Horse', ID = 17, TYPE = TYPE_MONSTER, CHANCE = 65, FAIL_MSG = { {1, 'The horse runs away.'}, {2, 'The horse ate the oats.'} }, SUCCESS_MSG = 'You have tamed the horse.'}
