...
CONFIG_GUILD_LEVEL = {
	quantityToLevel = 15000, -- points to next level
...
CONFIG_GUILD_MONSTERS = {
	...
	buyingMount = {pts = 1, msg = "The player %s just bought a mount on the store and earned %d points for your guild!"},
	buyingOutfit = {pts = 1, msg = "The player %s just bought an outfit on the store and earned %d points for your guild!"},
	killingPlayer = {level = 150, pts = 300, msg = "The player %s killed someone above level 50 and earned %d points for your guild!"}
}
