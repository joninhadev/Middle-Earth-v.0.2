...
std::string StoreOffer::getDisabledReason(Player* player)
{
    ...
    if (player->getVocationId() == 17 || player->getVocationId() == 18 || player->getVocationId() == 19 || player->getVocationId() == 20 || player->getVocationId() == 21 || player->getVocationId() == 22 || player->getVocationId() == 23 || player->getVocationId() == 24 || player->getVocationId() == 25 || player->getVocationId() == 26 || player->getVocationId() == 35 || player->getVocationId() == 36 || player->getVocationId() == 37 || player->getVocationId() == 38 || player->getVocationId() == 39) {
        disabledReason = "Your race doesn't allow you to buy addons.";
    } 
	} else if (type == OFFER_TYPE_OUTFIT_ADDON) {
		...
		if (value1 >= 4) {
			disabledReason = "Can be purchased up to 3 times between 2 server saves.";
