...
class Game
{
	public:
		...
		bool loadBoostBoss();
		std::string getBoostBoss() {
			return boostBossName;
		}
		void setBoostBoss(std::string Bossname, uint16_t Bossid);
		...
		bool loadBoostMonsterSecond();
		std::string getBoostMonsterSecond() {
			return boostMonsterSecond;
		}
		void setBoostMonsterSecond(std::string monsternameSecond, uint16_t monsteridSecond);


		bool loadBoostMonsterThird();
		std::string getBoostMonsterThird() {
			return boostMonsterThird;
		}
		void setBoostMonsterThird(std::string monsternameThird, uint16_t monsteridThird);
	...
	protected:
		...
		std::string boostBossName = "";
		std::string Bossname = "";
		std::string boostMonster = "";
		std::string boostMonsterSecond = "";
		std::string boostMonsterThird = "";
		uint16_t boostBoss = 1;
		uint16_t bossId = 1;
		uint16_t Bossid = 1;
		uint16_t boostBossId = 1;
		uint16_t boostRace = 1;
		uint16_t boostRaceSecond = 1;
		uint16_t boostRaceThird = 1;
