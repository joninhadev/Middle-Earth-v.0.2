...
void LuaScriptInterface::registerFunctions()
{
	...
	registerMethod("Game", "getBoostBoss", LuaScriptInterface::luaGameGetBoostBoss);
	registerMethod("Game", "setBoostBoss", LuaScriptInterface::luaGameSetBoostBoss);

	registerMethod("Game", "getBoostMonsterSecond", LuaScriptInterface::luaGameGetBoostMonsterSecond);
	registerMethod("Game", "setBoostMonsterSecond", LuaScriptInterface::luaGameSetBoostMonsterSecond);

	registerMethod("Game", "getBoostMonsterThird", LuaScriptInterface::luaGameGetBoostMonsterThird);
	registerMethod("Game", "setBoostMonsterThird", LuaScriptInterface::luaGameSetBoostMonsterThird);
...
int LuaScriptInterface::luaDoAreaCombat(lua_State* L)
{
	...
	if (area || areaId == 0) {
		...
		params.blockedByArmor = getBoolean(L, 9, false); /* Comentário do BUG ELEMENTAL */
...
int LuaScriptInterface::luaDoTargetCombat(lua_State* L)
{
	...
	params.blockedByArmor = getBoolean(L, 8, false); /* Comentário 2 UPDATE */
...
int LuaScriptInterface::luaGameGetBoostBoss(lua_State* L)
{
	// Game.getBoostBoss()
	pushString(L, g_game.getBoostBoss());
	return 1;
}

int LuaScriptInterface::luaGameSetBoostBoss(lua_State* L)
{
	// Game.setBoostMBoss(monster, id)
	std::string monster = getString(L, 1);
	uint16_t raceid = getNumber<uint16_t>(L, 2);

	g_game.setBoostBoss(monster, raceid);
	pushBoolean(L, true);
	return 1;
}
...
int LuaScriptInterface::luaGameGetBoostMonsterSecond(lua_State* L)
{
	// Game.getBoostMonsterSecond()
	pushString(L, g_game.getBoostMonsterSecond());
	return 1;
}

int LuaScriptInterface::luaGameSetBoostMonsterSecond(lua_State* L)
{
	// Game.setBoostMonsterSecond(monster, id)
	std::string monsterSecond = getString(L, 1);
	uint16_t raceidSecond = getNumber<uint16_t>(L, 2);

	g_game.setBoostMonsterSecond(monsterSecond, raceidSecond);
	pushBoolean(L, true);
	return 1;
}


int LuaScriptInterface::luaGameGetBoostMonsterThird(lua_State* L)
{
	// Game.getBoostMonsterThird()
	pushString(L, g_game.getBoostMonsterThird());
	return 1;
}

int LuaScriptInterface::luaGameSetBoostMonsterThird(lua_State* L)
{
	// Game.setBoostMonsterThird(monster, id)
	std::string monsterThird = getString(L, 1);
	uint16_t raceidThird = getNumber<uint16_t>(L, 2);

	g_game.setBoostMonsterThird(monsterThird, raceidThird);
	pushBoolean(L, true);
	return 1;
}
