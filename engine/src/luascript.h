...
class LuaScriptInterface
{
	...
	static int luaGameGetMonsters(lua_State* L);
		...
		static int luaGameGetBoostBoss(lua_State* L);
		static int luaGameSetBoostBoss(lua_State* L);
		static int luaGameGetBoostMonster(lua_State* L);
		static int luaGameSetBoostMonster(lua_State* L);
		static int luaGameGetBoostMonsterSecond(lua_State* L);
		static int luaGameSetBoostMonsterSecond(lua_State* L);
		static int luaGameGetBoostMonsterThird(lua_State* L);
		static int luaGameSetBoostMonsterThird(lua_State* L);
